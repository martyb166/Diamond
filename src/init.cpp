...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-autodustthreshold=<n>", strprintf(_("Combine dust transactions into one stake transaction (0-1, default: %u)"), 1));
    if (GetBoolArg("-help-debug", false)) {
    ...
    strUsage += HelpMessageOpt("-rpcport=<port>", strprintf(_("Listen for JSON-RPC connections on <port> (default: %u or testnet: %u)"), 51473, 17772));
